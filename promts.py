...
3. Правила построения:
   ...
   - На диаграмме обязательно обозначь начало алгоритма соответствующей фигурой с надписью "Начало".
   - На диаграмме обязательно обозначь выход из алгоритма или конец алгоритма соответствующей фигурой с надписью "Конец".
   - Начало алгоритма обозначай фигурой shape=mxgraph.flowchart.start_1
   - Выход из алгоритма или конец алгоритма обозначай фигурой shape=mxgraph.flowchart.terminator
   - Ветвления (условия) оформляй ромбами shape=mxgraph.flowchart.decision.
   - Каждый шаг алгоритма — отдельный блок (rectangle, decision, terminator и т.д.).
   - Шаги алгоритма, действия обозначай прямоугольником с закруглёнными углами (rectangle).
   - Для задержек/ожиданий используй блок "delay" shape=mxgraph.flowchart.delay.
   - Блок начала обязательно должен иметь одну исходящую стрелку.
   - Блоки выхода из алгоритма или конца алгоритма должны обязательно иметь одну или более входящих стрелок.
   - Блок шага алгоритма, действий должен иметь хотя бы одну входящую стрелку и хотя бы одну исходящую стрелку.
   - Блок ветвления, условий должен иметь хотя бы одну входящую стрелку и как минимум 2 исходящие стрелки.
   - Блок задержек/ожиданий должен иметь хотя бы одну входящую стрелку и хотя бы одну исходящую стрелку.
   ...
   - Проверяй что все блоки имеют необходимые соединения между собой в соответствии с алгоритмом.
...
```
Создай диаграмму по следующему алгоритму:
'''